...
export default function AdminUsersPage() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-y-auto w-full p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      {/* EL FIX DEL SCROLL EMPIEZA AQUÍ */}
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm flex flex-col max-h-[70vh]">
        
        {/* Este div controla la barra de desplazamiento de la tabla */}
        <div className="overflow-auto relative">
          <table className="w-full text-left text-sm whitespace-nowrap">
            
            {/* sticky top-0 y z-10 hacen que el título de las columnas no se pierda al bajar */}
            <thead className="bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-400 border-b border-zinc-200 dark:border-zinc-800 sticky top-0 z-10">
              <tr>
            ...
            <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
              {users.map((user) => (
                <tr key={user.id} className="hover:bg-zinc-50/50 dark:hover:bg-zinc-800/20 transition-colors">
                  ...
                  {/* ... (TODO EL CÓDIGO DE LAS CELDAS QUEDA EXACTAMENTE IGUAL QUE COMO LO TENÍAS) ... */}
