    ...
    <main className="flex flex-col flex-1 max-w-4xl mx-auto w-full p-4 sm:p-6 lg:p-8 space-y-8 bg-zinc-50 dark:bg-zinc-950 overflow-y-auto">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 border border-zinc-200 dark:border-zinc-800 shadow-sm space-y-6">
        ...
        <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800">
          <h3 className="text-sm font-medium text-zinc-900 dark:text-zinc-100 mb-4 ">Credenciales de Acceso</h3>
          <div className="flex items-center gap-4">
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-50 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400 ring-1 ring-inset ring-blue-700/10 dark:ring-blue-400/20">
              Credencial Activa: {translateRole(currentRole)}
            </span>
          </div>
        </div>
        ...
        {currentRole === "student" && (
          <div className="pt-6 border-t border-zinc-100 dark:border-zinc-800">
            <h3 className="text-sm font-medium text-zinc-900 dark:text-zinc-100 mb-2">Gestión de Credencial Académica</h3>
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-4 max-w-2xl">
              Para habilitar los módulos de gestión, es necesario someter su credencial actual a un proceso de auditoría y validación por parte de la administración.
            </p>
            ...
            {roleRequest === 'teacher' ? (
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-orange-50 dark:bg-orange-950/30 text-orange-700 dark:text-orange-400 border border-orange-200 dark:border-orange-900/50">
                ...
                Auditoría de credencial en proceso.
              </div>
            ) : (
              <div className="space-y-4">
                ...
                >
                  {isRequesting ? "Procesando requerimiento..." : "Iniciar proceso de acreditación"}
                </button>
                {requestStatus === "success" && (
                  <p className="text-sm text-green-600 dark:text-green-400">¡Requerimiento registrado! Su perfil se encuentra bajo auditoría institucional.</p>
                )}
                {requestStatus === "error" && (
                  <p className="text-sm text-red-600 dark:text-red-400">Error de comunicación con el servidor. Intente nuevamente más tarde.</p>
                )}
              </div>
            )}
          </div>
